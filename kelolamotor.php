...
$dataMotor = [
    ["nama"=>"HONDA SUPRA 125","plat"=>"L 276 TYN","tipe"=>"Bebek","tahun"=>"2020","gambar"=>"images/supra.png","status"=>"Dipinjam"],
    ["nama"=>"HONDA VARIO 120","plat"=>"L 736 NDU","tipe"=>"Matic","tahun"=>"2019","gambar"=>"images/vario.png","status"=>"Tersedia"],
    ["nama"=>"YAMAHA NMAX","plat"=>"L 191 BNA","tipe"=>"Matic","tahun"=>"2025","gambar"=>"images/nmax.png","status"=>"Tersedia"],
    ["nama"=>"HONDA PCX 160","plat"=>"L 837 NHD","tipe"=>"Matic","tahun"=>"2025","gambar"=>"images/pcx.png","status"=>"Tersedia"],
    ["nama"=>"HONDA BEAT ESP","plat"=>"L 837 KSD","tipe"=>"Matic","tahun"=>"2025","gambar"=>"images/beat.png","status"=>"Tersedia"],
    ["nama"=>"HONDA SCOOPY","plat"=>"L 326 KSJ","tipe"=>"Matic","tahun"=>"2025","gambar"=>"images/scoopy.png","status"=>"Maintenance"],
    ["nama"=>"HONDA VERZA","plat"=>"L 539 YDB","tipe"=>"Sport","tahun"=>"2025","gambar"=>"images/verza.png","status"=>"Dipinjam"],
    ["nama"=>"HONDA CB150R","plat"=>"L 736 NXU","tipe"=>"Sport","tahun"=>"2025","gambar"=>"images/cb150r.png","status"=>"Tersedia"],
    ["nama"=>"YAMAHA VIXION","plat"=>"L 983 NMJ","tipe"=>"Sport","tahun"=>"2025","gambar"=>"images/vixion.png","status"=>"Tersedia"]
];
?>
...
<div class="sidebar">
    ...
    <div class="menu">
        ...
        <a href="kelolamotor.php" class="kelolamotor active">Kelola Motor</a>
...
<div class="header">KELOLA MOTOR</div>
...
<tbody id="tableBody">
<?php $no=1; foreach($dataMotor as $m): ?>
<tr class="row-motor">
<td>
...
<td>
<div class="action">
<div class="edit"><img src="images/editfile.png"></div>
<div class="delete"><img src="images/hapusfile.png"></div>
</div>
</td>
</tr>
<?php endforeach; ?>
...
<script src="kelolamotor.js"></script>
