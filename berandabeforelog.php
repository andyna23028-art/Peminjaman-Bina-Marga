<?php
$currentPage = 'beranda before login';
?>
...
<head>
<meta charset="UTF-8">
<title>Beranda Before Login - DPU Bina Marga</title>
...
<header>
    ...
    <nav>
    <a href="#" onclick="harusLogin()" class="<?= $currentPage=='beranda before login'?'active':'' ?>">Beranda</a>
    <a href="#" onclick="harusLogin()">Tentang</a>
    <a href="#" onclick="harusLogin()">Pengaduan</a>
    <a href="#" onclick="harusLogin()">FAQ</a>
    </nav>

    <a href="#" onclick="harusLogin()">
...
<section class="hero fade-up">
    <div class="hero-content">
        ...
        <div class="hero-text">
            ...
            <button class="btn" onclick="location.href='loginuser.php'">
                Login Untuk Mulai
            </button>
        </div>
...
<section class="kategori-section fade-up">
    ...
    <div class="kategori-card" onclick="harusLogin()" style="cursor:pointer;">
        <h3>MOBIL</h3>
...
<script src="berandabeforelog.js"></script>
</body>
</html>